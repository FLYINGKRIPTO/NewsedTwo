...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<NewsFeatures>> {
    ...
    private static final String REQUESTED_URL = "https://content.guardianapis.com/search?q=Sports&format=json&order-by=newest&page-size=30&from-date=2018-09-01&show-fields=headline,thumbnail,short-url&show-tags=contributor,publication&api-key=751d026c-5315-4412-824f-90852ee18451";
